...
# /home/rohit/Studies/Thesis/Data/Download/ /home/rohit/Studies/Thesis/ProductDataClassification/output/
...
def main():
    ...
    image_download_log = output_path + "download_log.txt"
    output_file_df = output_path + "df_clean_on_market.p" # to store the dataframe obtained after CLEANING as pickle object
